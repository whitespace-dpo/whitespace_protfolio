    ...
    <>
      ...
      <div className={styles["content_container"]}>
        ...
        <div className={styles.row1}>
          <h4>The Goal</h4>
          <p>
            Blood Donor System permits donors to register a blood donation
            schedule with a specific date and time through the Internet. And the
            organizations can connect faster to donors with the appropriate
            blood type in emergency cases.{" "}
          </p>
        </div>
